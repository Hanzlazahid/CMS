...
<?php include '../include/db.php';  ?>
    ...
    <div id="wrapper" style="width:100vw;">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        $post_query=mysqli_fetch_assoc($select_all_posts_query);
                        $post_author=$post_query['post_author'];
...
$user_subscriber_count=mysqli_num_rows($select_all_subscriber);
